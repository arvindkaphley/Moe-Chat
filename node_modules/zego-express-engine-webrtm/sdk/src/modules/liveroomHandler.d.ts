...
import { LinkedList, ListNode, ZegoDataReport, ZegoLogger } from '../zego.entity';
...
export declare class LiveRoomHandler {
    ...
    isEncrypt: boolean;
    hasCryptSign: boolean;
    waitDecryptCmdList: Uint8Array[];
    waitDecryptTimer: NodeJS.Timeout | null | number;
    ...
    private k1SignLogoutBuffer;
    private protoInstance;
    swPushCmdList: string[];
    onSwitchCmdList: string[];
    unEncryptCmdList: string[];
    whiteboardPushCmdList: string[];
    private state;
    unStructCmdList: string[];
    joinLiveMap: any;
    reloginToken: string;
