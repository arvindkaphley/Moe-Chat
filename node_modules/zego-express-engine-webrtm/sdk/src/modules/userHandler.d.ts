...
export declare class UserHandler {
    ...
    private anchor_info;
    constructor(logger: ZegoLogger, stateCenter: StateCenter, dataReport: ZegoDataReport, service: LiveRoomService, liveRoomHandler: ZegoRoomServicer, room: LiveRoomModules);
