...
useEffect(()=>{
  ...
  return (
    <div className="absolute h-4/6 w-2/6 top-1/4 left-1/3 bg-gray-900 gap-3 rounded-lg pt-2 flex items-center justify-center">
      ...
      <div 
        className="pt-2 pr-2 cursor-pointer flex item-end justify-end" 
        onClick={()=>hide(false)}>
        ...
        <button className="h-16 w-16 bg-white rounded-full cursor-pointer border-8 border-teal-light p2 mb-10"
